...
class AttendanceStartButton extends Component {
    ...
    render() {
        return (<div>
            <Button variant="contained" onClick={this.dialogShowToggle} style={{backgroundColor:"#FFCA6E",width:'110px',height:'40px',fontFamily:'IBM Plex Sans KR',fontSize:'17px',borderRadius:'20px',fontWeight:'bold'}}>
                출근 입력
            </Button>
